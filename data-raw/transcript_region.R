...
download.file("ftp://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_33/gencode.v33.annotation.gtf.gz",
              "data-raw/gencode.v33.hg38.annotation.gtf.gz")

download.file("ftp://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_33/GRCh37_mapping/gencode.v33lift37.annotation.gtf.gz",
...
gtf_hg38[, `:=`(gene_name = extract_col(V9, "gene_name"),
...
gtf_hg19[, `:=`(gene_name = extract_col(V9, "gene_name"),
                gene_id = extract_col(V9, "gene_id"),
                gene_type = extract_col(V9, "gene_type")
)]
