...
test_that("sig_tally for CopyNumber works", {
  ...
  expect_type(cn_prepare, "list")
  cn_prepare2 <- sig_tally(cn, cores = 2, method = "W")
  expect_type(cn_prepare2, "list")
  # The result is reproducible
  cn_prepare <- sig_tally(cn, cores = 2, method = "W")
  expect_true(all.equal(cn_prepare, cn_prepare2))
  cn_prepare <- sig_tally(cn, keep_only_matrix = TRUE, method = "W")
  expect_type(cn_prepare, "integer")
})


test_that("sig_tally for MAF works", {
