...
df <- cran_downloads("sigminer", from = "2019-07-01", to = "2022-05-10")
...
if (!is.null(df)) {
  ...
  spiral_highlight("2022-01-01", "end",        type = "line", gp = gpar(col = 4))
  ...
  lgd = packLegend(
    ...
    Legend(title = "Year", type = "lines", at = 2019:2022,
