...
The code for extracting copy number signatures was based on the source code from 
paper *Copy number signatures and mutational processes in ovarian carcinoma*, 
...
The code for extracting mutational signatures was based inpart on the source 
